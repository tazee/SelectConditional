//
// SelectPolysByArea - A plugin for selecting edges by edge length
//
...
#define LXx_OVERRIDE override
    ...
    class CSelectPolysByArea : public CLxImpl_Tool, public CLxImpl_ToolModel, public CLxDynamicAttributes, public CLxImpl_ChannelUI
    {
    public:
        CSelectPolysByArea();
        ...
        double m_area, m_range0, m_range1;
