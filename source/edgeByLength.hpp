...
#define LXx_OVERRIDE override
    ...
    class CSelectEdgesByLength : public CLxImpl_Tool, public CLxImpl_ToolModel, public CLxDynamicAttributes, public CLxImpl_ChannelUI
    {
    public:
        CSelectEdgesByLength();
        ...
        double m_length, m_range1, m_range0;
